...
namespace DBfinalproject.DataSet1TableAdapters {
...
SELECT SSN, Fname, Minit, Lname, Email, Employee_Address, Gender, salary, Employee_Type, Birth_Date, Department_NUM, Hire_Date FROM Employee WHERE (SSN = @SSN)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT SSN, Fname, Minit, Lname, Email, Employee_Address, Gender, salary, Employe" +
                "e_Type, Birth_Date, Department_NUM, Hire_Date FROM dbo.Employee where Department" +
                "_NUM=@dno";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[0].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@dno", global::System.Data.SqlDbType.Int, 4, global::System.Data.ParameterDirection.Input, 0, 0, "Department_NUM", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int Fill(DataSet1.EmployeeDataTable dataTable, global::System.Nullable<int> dno) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((dno.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(dno.Value));
            }
            else {
        ...
        public virtual DataSet1.EmployeeDataTable GetData(global::System.Nullable<int> dno) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((dno.HasValue == true)) {
                this.Adapter.SelectCommand.Parameters[0].Value = ((int)(dno.Value));
            }
